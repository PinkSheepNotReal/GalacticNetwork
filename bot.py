...
async def help(ctx):
    ...
    embed5=discord.Embed(title="ModerationCommands", color=0xf4df42)
    embed5.add_field(name="ban", value="Ban someone", inline=False)
    embed5.add_field(name="kick", value="Kick someone", inline=False)
